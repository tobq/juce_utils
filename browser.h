...
//            if (browser != nullptr)
//            {
//                VARIANT headerFlags, frame, postDataVar, headersVar;  // (_variant_t isn'loop_thread available in all compilers)
...
//
//                    // setting this bool tells the browser to ignore the event_handle - we'll handle it.
